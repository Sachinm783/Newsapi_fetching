...
export class News extends Component {
  ...
  async updateNews(){
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=c401ae136bd6492db4da3f63cafea7d2&page=${this.state.page}&pageSize=${this.props.pageSize}`;
